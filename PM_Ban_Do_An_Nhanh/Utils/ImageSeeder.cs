    ...
    public static class ImageSeeder
    {
        public static void SeedIfNeeded()
        {
            try
            {
                ...
                CreateSampleImage(Path.Combine(imagesDir, "Banh_mi_15000.jpg"), "Bánh m?", 15000);
                CreateSampleImage(Path.Combine(imagesDir, "Tra_da_5000.jpg"), "Trà ðá", 5000);
        ...
        private static void CreateSampleImage(string path, string title, int price)
        {
            ...
            using (Graphics g = Graphics.FromImage(bmp))
            {
                ...
                {
                    string p = price.ToString("N0") + " VNÐ";
